  ...
  return (
    <div className="flex flex-col gap-5 py-4 lg:gap-8 md:py-6 lg:px-6">
      ...
      <div className="grid max-lg:grid-cols-2 grid-cols-4 gap-8">
        <div className="p-3 bg-accent rounded-md border border-sidebar-ring flex items-center justify-between">
        ...
        <div className="p-3 bg-accent rounded-md border border-sidebar-ring flex items-center justify-between">
          ...
          <p className="px-3 py-1 rounded-sm bg-success text-success-foreground self-end">
            <CountUp
              start={0}
              end={ordersProgress}
              duration={5}
